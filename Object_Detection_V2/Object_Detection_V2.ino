const char* ssid     = "MIP_JIO2";  //Wifi SSID and Password 
const char* password = "dandi@12345"; // password
 
const char* apssid = "ESP32-CAM"; //ssid and pasword 
const char* appassword = "12345678";    
 
#include <WiFi.h>  // WiFi libarary which help to connect eifi
#include <WiFiClientSecure.h> // Secure connection for WiFi
#include "esp_camera.h"   // ESP32 Cam Library       
#include "soc/soc.h"      // trigger th e watch dog      
#include "soc/rtc_cntl_reg.h"   // rtc control
 
String Feedback="";   //fedback varialble, save the feedback from user
 
String Command="",cmd="",P1="",P2="",P3="",P4="",P5="",P6="",P7="",P8="",P9=""; // save the pointer location
 
byte ReceiveState=0,cmdState=1,strState=1,questionstate=0,equalstate=0,semicolonstate=0; // variables
